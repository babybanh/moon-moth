...
describe('route math', () => {
  ...
  it('staggers idle forward nudges with longer waits and durations', () => {
    ...
    expect(idleForwardPushWaitMs(4)).toBe(6000)
    expect(idleForwardPushWaitMs(6)).toBe(8000)
    expect(idleForwardPushWaitMs(8)).toBe(8000)
    expect(idleForwardPushDurationMs(2300, 0)).toBe(2990)
    expect(idleForwardPushDurationMs(2300, 1)).toBe(3887)
    expect(idleForwardPushDurationMs(2300, 2)).toBe(5053)
